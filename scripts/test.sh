...
./make_logo_from_msa.py ../_out/msa_match_mismatch.msa --out ../_out/logo_match_mismatch2.png
./make_logo_from_msa.py ../_out/msa_similarity.msa --out ../_out/logo_similarity2.png
